...
public class ServiceAccesFicheServiceImplBouchon implements ServiceAccesFicheService {
    ...
    public void fournirDesFichesServiceAUneListe() {
        ...
        ficheService1.setTypeDeService(TypeServiceEnum.ELEARNING);
        ...
        ficheService2.setTypeDeService(TypeServiceEnum.MOOC);
        ...
        ficheService3.setTypeDeService(TypeServiceEnum.ELEARNING);
